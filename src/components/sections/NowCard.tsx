...
const NOW_ITEMS = [
  {
    ...
    tag: "BUILDING",
    title: "OnwardOS",
    body: "AI-native study-abroad suite - LangGraph pipelines, Claude orchestration, pgvector retrieval.",
  },
  {
    Icon: Target,
    tag: "REFINING",
    title: "Production agent patterns",
    body: "Checkpoint recovery, structured-output reliability, multi-product session propagation - taking what worked this year and packaging it.",
  },
  {
    Icon: Sparkles,
    tag: "AVAILABLE",
      ...
      <div className="flex items-baseline justify-between mb-5">
        <div>
          ...
          <h2 className="mt-1 text-xl font-semibold text-ink">
            What I&apos;m <span className="text-primary">building right now</span>
          </h2>
        </div>
      ...
      <ul className="space-y-3">
        {NOW_ITEMS.map((item, i) => (
          <li
            key={i}
            data-cursor-hover
            className="group flex items-start gap-3 p-3 rounded-xl bg-paper border border-hairline hover:border-primary/30 hover:shadow-card transition"
          >
